...
add_action('network_admin_menu', 'wind_addProvisionUsersPage');
add_action('network_admin_menu', 'wind_addSettingsPage');
add_action('network_admin_menu', 'wind_addDerovisionUsersPage');

// remove the "add users" submenu
...
if ($wind_enable_plugin) {
	add_action('wp_authenticate', 'wind_authenticate', 1, 2);
